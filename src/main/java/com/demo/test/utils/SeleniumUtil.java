...
public class SeleniumUtil {
    ...
    /**点击alert确定按钮*/
    public void alert(By byElement){
...
//            } else {
//                System.out.println("没有找到pin");
//            }
//
//        }
        driver.manage().deleteAllCookies();
        Cookie cook = new Cookie("pin","test_pop_shangyao1" );
        Cookie cook1 = new Cookie("thor","" );
        Cookie cook2 = new Cookie("3AB9D23F7A4B3C9B","KT6SSOI4QRUZR62XHXQTGCCARIBI7E6IYIVG3ANNRBUZCVRDFIHL3ROFVY6EOBHABD337AE5MRWEZOP6YKQ5MUYRUQ" );
        Cookie cook3 = new Cookie("TrackID","1rAu9K8bfNjlwAtWugMDQgL4LShYGfjbkMRudByMn6HxKHrA70l2hu8_TuZIyZ-DY3gUqFtn4q8dmNnqffrhtXrijQ02ecgM7hYpCQ53ekfY" );
        Cookie cook4 = new Cookie("pinId","pVvgI0wl9KgjhcYhU4hpgQjsW_PU2xti" );
        Cookie cook5 = new Cookie("unick","test_pop_shangyao1" );
        Cookie cook6 = new Cookie("wlfstk_smdl","b1bdpsw11c9uy1lv9ju6aggh0d43vk27" );
        Cookie cook7 = new Cookie("logining","1" );
        Cookie cook8 = new Cookie("ceshi3.com","000" );
        Cookie cook9 = new Cookie("_tp","C0YVEOhWeRO7vmwVbXFgtH32BHn2T1fpVImXwP5YxCw%3D" );
        Cookie cook10 = new Cookie("_pst","test_pop_shangyao1" );
        Cookie cook11 = new Cookie("__jdv","122270672|direct|-|none|-|1527674103562" );
        Cookie cook12 = new Cookie("__jdu","15276741035621235695004" );
        Cookie cook13 = new Cookie("__jdc","122270672" );
        Cookie cook14 = new Cookie("__jdb","122270672.2.15276741035621235695004|1.1527674104" );
        Cookie cook15 = new Cookie("__jda","122270672.15276741035621235695004.1527674104.1527674104.1527674104.1" );

        driver.manage().addCookie(cook);
        driver.manage().addCookie(cook1);
        driver.manage().addCookie(cook2);
        driver.manage().addCookie(cook3);
        driver.manage().addCookie(cook4);
        driver.manage().addCookie(cook5);
        driver.manage().addCookie(cook6);
        driver.manage().addCookie(cook7);
        driver.manage().addCookie(cook8);
        driver.manage().addCookie(cook9);
        driver.manage().addCookie(cook10);
        driver.manage().addCookie(cook11);
        driver.manage().addCookie(cook12);
        driver.manage().addCookie(cook13);
        driver.manage().addCookie(cook14);
        driver.manage().addCookie(cook15);
       ...
       for (Cookie c : cookies) {
        ...
        driver.get("http://yaojingcai.jd.com/vender/b/index.htm");
    ...
    /** 隐式等待 implicitlyWait。识别对象时的超时时间。过了这个时间如果对象还没找到的话就会抛出NoSuchElement异常 */
